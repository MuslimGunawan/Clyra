        ...
        <form onSubmit={handleExtract} className="space-y-3">
          <div className="relative flex items-center">
            <input
              ...
              className="w-full bg-[#08090d] border border-slate-800 focus:border-indigo-500 rounded-2xl pl-4 pr-44 sm:pr-52 py-3.5 text-xs sm:text-sm text-white placeholder:text-slate-500 outline-none transition-all shadow-inner font-mono"
            />

            {/* Unified Right Actions Container (Flexbox prevents overlap) */}
            <div className="absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-1.5">
              ...
              <button
                type="button"
                onClick={handlePaste}
                className="px-2.5 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-mono transition-colors flex items-center gap-1 cursor-pointer border border-slate-700/60"
              ...
              <button
                ...
                className="px-3.5 sm:px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-md shadow-indigo-600/30 transition-all active:scale-95 disabled:opacity-50 flex items-center gap-1.5 cursor-pointer whitespace-nowrap"
              >
                {isProcessing ? (
                  <>
