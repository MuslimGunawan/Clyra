...
export default function PromptCard({ prompt, onOpenModal }: PromptCardProps) {
      ...
      <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
        ...
        <div className="pt-2.5 border-t border-slate-800/60 flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1 rounded-md bg-indigo-600/20 hover:bg-indigo-600/40 text-indigo-300 border border-indigo-500/30 text-xs font-medium transition-all active:scale-95"
          >
            {copied ? (
              <>
