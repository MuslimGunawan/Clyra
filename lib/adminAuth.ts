 ...
 * Provides single-role admin authentication, session tokens, and anti-bruteforce lockouts.
 */

const DEFAULT_MASTER_KEY = "clyra_admin_2026";
const SESSION_KEY = "cly_adm_sess_token";
...
/**
 * Validates the admin master key and creates an encrypted session token.
 */
