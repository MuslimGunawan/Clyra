    ...
    <div className="min-h-screen bg-[#07090e] text-slate-100 flex flex-col justify-between relative overflow-hidden font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md bg-[#0c0e18] border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 relative overflow-hidden">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="nama@emailanda.com atau admin"
          ...
          {/* Admin Fast Pass & Activation Links */}
          <div className="pt-3 border-t border-slate-800/80 space-y-3 text-center">
            {/* Quick Admin fill button */}
            <button
              type="button"
              onClick={handleQuickAdminLogin}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-purple-950/40 hover:bg-purple-900/60 border border-purple-800/50 text-purple-300 text-[11px] font-mono transition-colors cursor-pointer"
            >
              <ShieldCheck className="w-3 h-3 text-purple-400" />
              <span>👑 Masuk sebagai Admin Master Preview</span>
            </button>
            ...
            <div>
              ...
              <DynamicLink
                ...
                className="inline-block text-xs font-semibold text-indigo-400 hover:text-indigo-300 underline underline-offset-4 mt-1"
              >
